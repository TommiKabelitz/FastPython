...
fortran_module_compilation = [fortran_compiler,'fortmod.f90','-c','-o','fortmod.o'] + compiler_flags
shared_object_compilation = [fortran_compiler,'fort_interface.f90','-c','-o','fort_interface.o'] + compiler_flags
...
ext_modules = [Extension(# module name to create (.so file)
                         'fortmod',
                         # cython source file
                         ['fort_interface.pyx'],
